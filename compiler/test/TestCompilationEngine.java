...
public class TestCompilationEngine {
    ...
    public void testToknizer() {
        ...
        File output = new File("./testFiles/testCode1T.xml");
    ...
    public void testArrayTest() {
        ...
        File output = new File("./testFiles/ArrayTest/myMainT.xml");
        CompilationEngine ce = new CompilationEngine(input, output);
    ...
    public void testSquare() {
        ...
        File output = new File("./testFiles/Square/myMainT.xml");
        ...
        output = new File("./testFiles/Square/mySquareT.xml");
        ...
        output = new File("./testFiles/Square/mySquareGameT.xml");
